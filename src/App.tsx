...
export default function App() {
  ...
  const handleResetData = () => {
    setConfirmModal({
      ...
      message:
        'Toàn bộ dữ liệu hiện tại sẽ được thay thế bằng dữ liệu mẫu ban đầu của Cô Hoàng Thị Hoài. Cô có muốn tiếp tục?',
      isDestructive: false,
      onConfirm: () => {
        ...
        notify(
          ...
          'Dữ liệu mẫu Anh văn THCS Nguyễn Thái Bình đã sẵn sàng.'
        );
      },
    });
  };
