...
export const DataManagementModal: React.FC<DataManagementModalProps> = ({
  ...
  const handleExport = () => {
    ...
    onNotify('success', 'Đã xuất dữ liệu thành công', 'Tệp tin JSON đã được tải về thiết bị của cô.');
  };
        ...
        <div className="p-6 space-y-5 max-h-[75vh] overflow-y-auto">
          ...
          <div className="flex items-start gap-3 p-3.5 bg-blue-50/70 border border-blue-200/80 rounded-xl text-xs text-blue-900 leading-relaxed">
            ...
            <p>
              ...
              Cô có thể xuất tệp JSON để chuyển sang máy tính xách tay hoặc trình chiếu trên lớp dễ dàng.
            </p>
          </div>
