  ...
  return (
    <div id="grades-view" className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-slate-200">
        <div>
          <h2 className="text-xl font-bold text-slate-900">Quản lý Điểm số môn Anh văn</h2>
          <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
            Nhập điểm kiểm tra từ vựng, ngữ pháp, 4 kỹ năng Nghe-Nói-Đọc-Viết và phân tích thống kê
          </p>
        </div>
        <button
          id="add-grade-btn"
        ...
        >
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-xs font-bold text-slate-700 mb-1">
                  Lời phê của cô / Ghi chú
                </label>
                <textarea
                  value={note}
                  onChange={(e) => setNote(e.target.value)}
                  rows={2}
                  placeholder="Ví dụ: Phát âm tốt, từ vựng phong phú, cần rèn thêm cách chia thì..."
