    ...
    <div id="progress-view" className="space-y-8 animate-in fade-in duration-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="p-5 rounded-2xl bg-white border border-slate-200/90 shadow-2xs">
          ...
          <p className="text-[11px] text-slate-400 mt-2">Môn Anh văn THCS</p>
        </div>
      </div>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Những học sinh có bài tập chưa hoàn thành hoặc kết quả bài làm cần sự hỗ trợ, khích lệ từ cô
              </p>
            </div>
          </div>
