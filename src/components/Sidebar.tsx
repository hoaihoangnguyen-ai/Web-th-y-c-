        ...
        <div className="p-4 border-t border-slate-100 bg-slate-50/70">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="text-xs font-bold text-slate-800 truncate">Cô Hoàng Thị Hoài</p>
              <p className="text-[11px] text-slate-500 truncate">Anh văn • THCS Nguyễn Thái Bình</p>
            </div>
          </div>
        </div>
      </aside>
