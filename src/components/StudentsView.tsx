  ...
  const handleExportExcel = () => {
    ...
    const classSuffix =
      selectedClassId !== 'ALL'
        ...
        : '_TatCaLop';
    XLSX.writeFile(workbook, `Danh_sach_hoc_sinh_Anh_van${classSuffix}.xlsx`);
  };
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-slate-200">
        <div>
          ...
          <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
            Tổng số: <strong className="text-blue-700">{data.students.length}</strong> học sinh đang theo học môn Anh văn
          </p>
        </div>
